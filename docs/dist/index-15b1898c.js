...
class GeneratorCircle extends BodyGenerator {
  generate() {
    ...
    addDots(Math.ceil(MAX_DOTS / 3), new Vector(600, 400), 200, "#f8a5a5");
    addDots(Math.ceil(MAX_DOTS / 3), new Vector(900, 400), 200, "#faeb9e");
    addDots(Math.ceil(MAX_DOTS / 3), new Vector(800, 900), 200, "#d0ecc2");
    return bodyList2;
  }
}
  ...
  (function(f) {
    ...
    return function() {
      ...
      (function(global, factory) {
        typeof exports2 === "object" && typeof module2 !== "undefined" ? factory(exports2) : (global = global || self, factory(global.acorn = {}));
...
${indent}})();`);
    ...
    }, {}], 4: [function(require, module2, exports2) {
      ...
      function apiDecorate(kernel2) {
        kernel2.setOutput = (output) => {
          kernel2.output = setupOutput(output);
          if (kernel2.graphical) {
            setupGraphical(kernel2);
          }
        };
        kernel2.toJSON = () => {
          throw new Error("Not usable with gpuMock");
        };
        kernel2.setConstants = (flag) => {
          kernel2.constants = flag;
          return kernel2;
        };
        kernel2.setGraphical = (flag) => {
          kernel2.graphical = flag;
          return kernel2;
        };
        kernel2.setCanvas = (flag) => {
          kernel2.canvas = flag;
          return kernel2;
        };
        kernel2.setContext = (flag) => {
          kernel2.context = flag;
          return kernel2;
        };
        kernel2.destroy = () => {
        };
        kernel2.validateSettings = () => {
        };
        if (kernel2.graphical && kernel2.output) {
          setupGraphical(kernel2);
        }
        kernel2.exec = function() {
          return new Promise((resolve, reject) => {
            try {
              resolve(kernel2.apply(kernel2, arguments));
            } catch (e) {
              reject(e);
            }
          });
        };
        kernel2.getPixels = (flip) => {
          const { x, y } = kernel2.output;
          return flip ? flipPixels(kernel2._imageData.data, x, y) : kernel2._imageData.data.slice(0);
        };
        kernel2.color = function(r, g, b, a) {
          ...
          b = Math.floor(b * 255);
          a = Math.floor(a * 255);
          const width = kernel2.output.x;
          const height = kernel2.output.y;
          const x = kernel2.thread.x;
          const y = height - kernel2.thread.y - 1;
          const index = x + y * width;
          kernel2._colorData[index * 4 + 0] = r;
          kernel2._colorData[index * 4 + 1] = g;
          kernel2._colorData[index * 4 + 2] = b;
          kernel2._colorData[index * 4 + 3] = a;
        };
        const mockMethod = () => kernel2;
        const methods = [
          "setWarnVarUsage",
          "setArgumentTypes",
          "setTactic",
        ...
        for (let i = 0; i < methods.length; i++) {
          kernel2[methods[i]] = mockMethod;
        }
        return kernel2;
      }
      function setupGraphical(kernel2) {
        const { x, y } = kernel2.output;
        if (kernel2.context && kernel2.context.createImageData) {
          const data = new Uint8ClampedArray(x * y * 4);
          kernel2._imageData = kernel2.context.createImageData(x, y);
          kernel2._colorData = data;
        } else {
          const data = new Uint8ClampedArray(x * y * 4);
          kernel2._imageData = { data };
          kernel2._colorData = data;
        }
      }
      ...
      function gpuMock(fn, settings = {}) {
        ...
        function kernel2() {
          if (kernel2.output.z) {
            return mock3D.apply(kernel2, arguments);
          } else if (kernel2.output.y) {
            if (kernel2.graphical) {
              return mock2DGraphical.apply(kernel2, arguments);
            }
            return mock2D.apply(kernel2, arguments);
          } else {
            return mock1D.apply(kernel2, arguments);
          }
        }
        kernel2._fn = fn;
        kernel2.constants = settings.constants || null;
        kernel2.context = settings.context || null;
        kernel2.canvas = settings.canvas || null;
        kernel2.graphical = settings.graphical || false;
        kernel2._imageData = null;
        kernel2._colorData = null;
        kernel2.output = output;
        kernel2.thread = {
          x: 0,
          y: 0,
          z: 0
        };
        return apiDecorate(kernel2);
      }
  ...
  ${utils.getFunctionBodyFromString(fnString)}
    ...
    }, { "./utils": 114 }], 6: [function(require, module2, exports2) {
...
${updateArr.join("")};`);
    ...
    }, { "../function-node": 10 }], 7: [function(require, module2, exports2) {
      const { utils } = require("../../utils");
...
${cpuKernel._kernelString}
  ...
  return kernel;
    ...
    }, { "../../utils": 114 }], 8: [function(require, module2, exports2) {
      ...
      class CPUKernel extends Kernel {
        ...
        static getSignature(kernel2, argumentTypes) {
...
`).join("        ")}
    ...
    }, { "../../utils": 114, "../function-builder": 9, "../kernel": 36, "./function-node": 6, "./kernel-string": 7 }], 9: [function(require, module2, exports2) {
      class FunctionBuilder {
        static fromKernel(kernel2, FunctionNode, extraNodeOptions) {
          const {
            kernelArguments,
            kernelConstants,
            argumentNames,
 ...
 ${debugString}`);
    ...
    }, { "../utils": 114, "./function-tracer": 11, "acorn": 1 }], 11: [function(require, module2, exports2) {
      const { utils } = require("../utils");
      function last(array) {
    ...
    }, { "../utils": 114 }], 12: [function(require, module2, exports2) {
      ...
      function glKernelString(Kernel, args, originKernel, setupContextString, destroyContextString) {
        ...
        const context = glWiretap(originKernel.context, {
          ...
          onReadPixels: (targetName) => {
            if (kernel2.subKernels) {
              if (!subKernelsResultVariableSetup) {
                postResult.push(`    const result = { result: ${getRenderString(targetName, kernel2)} };`);
                subKernelsResultVariableSetup = true;
              } else {
                const property = kernel2.subKernels[subKernelsResultIndex++].property;
                postResult.push(`    result${isNaN(property) ? "." + property : `[${property}]`} = ${getRenderString(targetName, kernel2)};`);
              }
              if (subKernelsResultIndex === kernel2.subKernels.length) {
                postResult.push("    return result;");
              }
              return;
            }
            if (targetName) {
              postResult.push(`    return ${getRenderString(targetName, kernel2)};`);
            } else {
              postResult.push(`    return null;`);
            }
          },
          onUnrecognizedArgumentLookup: (argument) => {
            const argumentName = findKernelValue(argument, kernel2.kernelArguments, [], context);
            if (argumentName) {
              return argumentName;
            }
            const constantName = findKernelValue(argument, kernel2.kernelConstants, constants ? Object.keys(constants).map((key) => constants[key]) : [], context);
            if (constantName) {
              return constantName;
            }
            return null;
        ...
        const kernel2 = new Kernel(source, {
          canvas,
          context,
          checkContext: false,
          output,
        ...
        let result = [];
        context.setIndent(2);
        kernel2.build.apply(kernel2, args);
        result.push(context.toString());
        context.reset();
        kernel2.kernelArguments.forEach((kernelArgument, i) => {
        ...
        if (kernel2.renderOutput !== kernel2.renderTexture && kernel2.formatValues) {
          result.push(`  const renderOutput = function ${toStringWithoutUtils(kernel2.formatValues)};`);
        }
        result.push("/** end of injected functions **/");
        result.push(`  const innerKernel = function (${kernel2.kernelArguments.map((kernelArgument) => kernelArgument.varName).join(", ")}) {`);
        context.setIndent(4);
        kernel2.run.apply(kernel2, args);
        if (kernel2.renderKernels) {
          kernel2.renderKernels();
        } else if (kernel2.renderOutput) {
          kernel2.renderOutput();
        }
        result.push("    /** start setup uploads for kernel values **/");
        kernel2.kernelArguments.forEach((kernelArgument) => {
          result.push("    " + kernelArgument.getStringValueHandler().split("\n").join("\n    "));
        });
        result.push("    /** end setup uploads for kernel values **/");
        result.push(context.toString());
        if (kernel2.renderOutput === kernel2.renderTexture) {
          context.reset();
          const framebufferName = context.getContextVariableName(kernel2.framebuffer);
          if (kernel2.renderKernels) {
            const results = kernel2.renderKernels();
            const textureName = context.getContextVariableName(kernel2.texture.texture);
            result.push(`    return {
      result: {
        texture: ${textureName},
        ...
        toArray: ${getToArrayString(results.result, textureName, framebufferName)}
            ...
            const { subKernels: subKernels2, mappedTextures } = kernel2;
      ...
      ${subKernel.property}: {
        ...
        toArray: ${getToArrayString(subKernelResult, subKernelTextureName, framebufferName)}
            ...
            const rendered = kernel2.renderOutput();
            const textureName = context.getContextVariableName(kernel2.texture.texture);
            result.push(`    return {
        texture: ${textureName},
        type: '${rendered.type}',
        ...
        result.push("  };");
        if (kernel2.graphical) {
          result.push(getGetPixelsString(kernel2));
...
${result.join("\n")}
      ...
      function getRenderString(targetName, kernel2) {
        const readBackValue = kernel2.precision === "single" ? targetName : `new Float32Array(${targetName}.buffer)`;
        if (kernel2.output[2]) {
          return `renderOutput(${readBackValue}, ${kernel2.output[0]}, ${kernel2.output[1]}, ${kernel2.output[2]})`;
        }
        if (kernel2.output[1]) {
          return `renderOutput(${readBackValue}, ${kernel2.output[0]}, ${kernel2.output[1]})`;
        }
        return `renderOutput(${readBackValue}, ${kernel2.output[0]})`;
      }
      function getGetPixelsString(kernel2) {
        const getPixels = kernel2.getPixels.toString();
        ...
        return utils.flattenFunctionToString(`${useFunctionKeyword ? "function " : ""}${getPixels}`, {
          ...
          thisLookup: (property) => {
            ...
            if (kernel2.hasOwnProperty(property)) {
              return JSON.stringify(kernel2[property]);
            }
  ...
  return toArray();
    ...
    }, { "../../utils": 114, "gl-wiretap": 3 }], 13: [function(require, module2, exports2) {
      const { Kernel } = require("../kernel");
      const { utils } = require("../../utils");
      ...
      return 1;
          ...
          const kernel2 = new this(kernelString, {
          ...
          kernel2.build();
          kernel2.run();
          const result = kernel2.renderOutput();
          kernel2.destroy(true);
          return result[0] === 1;
        }
        static getIsIntegerDivisionAccurate() {
          ...
          const kernel2 = new this(kernelFunction.toString(), {
            context: this.testContext,
            canvas: this.testCanvas,
            validate: false,
            output: [2],
        ...
        static getSignature(kernel2, argumentTypes) {
          return kernel2.getVariablePrecisionString() + (argumentTypes.length > 0 ? ":" + argumentTypes.join(",") : "");
        }
...
`;
    ...
    }, { "../../../utils": 114, "./float": 25 }], 15: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 16: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 17: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 18: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 19: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 20: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 21: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 22: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 23: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 24: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 25: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "./index": 27 }], 26: [function(require, module2, exports2) {
    ...
    }, { "./unsigned": 33 }], 27: [function(require, module2, exports2) {
      ...
      class GLTexture extends Texture {
        ...
        cloneTexture() {
          this.texture._refs--;
          const { context: gl, size, texture, kernel: kernel2 } = this;
          if (kernel2.debug) {
    ...
    }, { "../../../texture": 113 }], 28: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 29: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 30: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureFloat } = require("./float");
    ...
    }, { "../../../utils": 114, "./float": 25 }], 31: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureUnsigned } = require("./unsigned");
    ...
    }, { "../../../utils": 114, "./unsigned": 33 }], 32: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTextureUnsigned } = require("./unsigned");
    ...
    }, { "../../../utils": 114, "./unsigned": 33 }], 33: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { GLTexture } = require("./index");
    ...
    }, { "../../../utils": 114, "./index": 27 }], 34: [function(require, module2, exports2) {
...
`;
    ...
    }, { "../gl/kernel-string": 12, "../web-gl/kernel": 70, "gl": 2 }], 35: [function(require, module2, exports2) {
      class KernelValue {
    ...
    }, {}], 36: [function(require, module2, exports2) {
      const { utils } = require("../utils");
      ...
      class Kernel {
        ...
        static getArgumentTypes(kernel2, args) {
          const argumentTypes = new Array(args.length);
          for (let i = 0; i < args.length; i++) {
            const arg = args[i];
            const type = kernel2.argumentTypes[i];
            if (arg.type) {
    ...
    }, { "../input": 110, "../utils": 114 }], 37: [function(require, module2, exports2) {
...
`);
    ...
    }, { "../../utils": 114, "../function-node": 10 }], 39: [function(require, module2, exports2) {
    ...
    }, { "../../../input": 110, "./index": 59 }], 41: [function(require, module2, exports2) {
      const { WebGLKernelValue } = require("./index");
...
`;
    ...
    }, { "./index": 59 }], 42: [function(require, module2, exports2) {
      const { WebGLKernelValue } = require("./index");
...
`;
    ...
    }, { "./index": 59 }], 43: [function(require, module2, exports2) {
      const { WebGLKernelValue } = require("./index");
...
`;
    ...
    }, { "./index": 59 }], 44: [function(require, module2, exports2) {
      require("../../../utils");
      const { WebGLKernelValue } = require("./index");
...
`;
    ...
    }, { "../../../utils": 114, "./index": 59 }], 45: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "./html-image": 57 }], 46: [function(require, module2, exports2) {
    ...
    }, { "./dynamic-html-image": 45 }], 47: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "./memory-optimized-number-texture": 61 }], 48: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "./number-texture": 62 }], 49: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "./single-array": 63 }], 50: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "./single-array1d-i": 64 }], 51: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "./single-array2d-i": 65 }], 52: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "./single-array3d-i": 66 }], 53: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "./single-input": 67 }], 54: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "./unsigned-array": 68 }], 55: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "./unsigned-input": 69 }], 56: [function(require, module2, exports2) {
      require("../../../utils");
      const { WebGLKernelValue } = require("./index");
...
`;
    ...
    }, { "../../../utils": 114, "./index": 59 }], 57: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
...
`;
    ...
    }, { "../../../utils": 114, "./array": 40 }], 58: [function(require, module2, exports2) {
      const { WebGLKernelValueHTMLImage } = require("./html-image");
    ...
    }, { "./html-image": 57 }], 59: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../kernel-value": 35 }], 60: [function(require, module2, exports2) {
      require("../../../utils");
      const { WebGLKernelValue } = require("./index");
...
`;
    ...
    }, { "../../../utils": 114, "./index": 59 }], 61: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { WebGLKernelArray } = require("./array");
...
`;
        ...
        updateValue(inputTexture) {
          ...
          const { kernel: kernel2, context: gl } = this;
          if (kernel2.pipeline) {
            if (kernel2.immutable) {
              kernel2.updateTextureArgumentRefs(this, inputTexture);
            } else {
              if (kernel2.texture && kernel2.texture.texture === inputTexture.texture) {
                throw new Error(sameError);
              } else if (kernel2.mappedTextures) {
                const { mappedTextures } = kernel2;
                for (let i = 0; i < mappedTextures.length; i++) {
    ...
    }, { "../../../utils": 114, "./array": 40 }], 62: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { WebGLKernelArray } = require("./array");
...
`;
    ...
    }, { "../../../utils": 114, "./array": 40, "./memory-optimized-number-texture": 61 }], 63: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { WebGLKernelArray } = require("./array");
    ...
    }, { "../../../utils": 114, "./array": 40 }], 64: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { WebGLKernelArray } = require("./array");
    ...
    }, { "../../../utils": 114, "./array": 40 }], 65: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { WebGLKernelArray } = require("./array");
    ...
    }, { "../../../utils": 114, "./array": 40 }], 66: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { WebGLKernelArray } = require("./array");
    ...
    }, { "../../../utils": 114, "./array": 40 }], 67: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { WebGLKernelArray } = require("./array");
    ...
    }, { "../../../utils": 114, "./array": 40 }], 68: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { WebGLKernelArray } = require("./array");
    ...
    }, { "../../../utils": 114, "./array": 40 }], 69: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
      const { WebGLKernelArray } = require("./array");
    ...
    }, { "../../../utils": 114, "./array": 40 }], 70: [function(require, module2, exports2) {
...
float integerCorrectionModulo(float number, float divisor) {
  ...
  return number - (divisor * floor(divWithIntCheck(number, divisor)));
    ...
    }, { "../../plugins/math-random-uniformly-distributed": 112, "../../utils": 114, "../function-builder": 9, "../gl/kernel": 13, "../gl/kernel-string": 12, "./fragment-shader": 37, "./function-node": 38, "./kernel-value-maps": 39, "./vertex-shader": 71 }], 71: [function(require, module2, exports2) {
...
void main(void) {
  ...
  vTexCoord = aTexCoord;
    ...
    }, {}], 72: [function(require, module2, exports2) {
...
void main(void) {
  ...
  __MAIN_RESULT__;
    ...
    }, {}], 73: [function(require, module2, exports2) {
      const { utils } = require("../../utils");
    ...
    }, { "../../utils": 114, "../web-gl/function-node": 38 }], 74: [function(require, module2, exports2) {
    ...
    }, { "../../web-gl/kernel-value/array2": 41 }], 76: [function(require, module2, exports2) {
    ...
    }, { "../../web-gl/kernel-value/array3": 42 }], 77: [function(require, module2, exports2) {
    ...
    }, { "../../web-gl/kernel-value/array4": 43 }], 78: [function(require, module2, exports2) {
    ...
    }, { "../../web-gl/kernel-value/boolean": 44 }], 79: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "./html-image-array": 92 }], 80: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/dynamic-html-image": 45 }], 81: [function(require, module2, exports2) {
      require("../../../utils");
    ...
    }, { "../../../utils": 114, "./dynamic-html-image": 80 }], 82: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/dynamic-memory-optimized-number-texture": 47 }], 83: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/dynamic-number-texture": 48 }], 84: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl2/kernel-value/single-array": 98 }], 85: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl2/kernel-value/single-array1d-i": 99 }], 86: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl2/kernel-value/single-array2d-i": 100 }], 87: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl2/kernel-value/single-array3d-i": 101 }], 88: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl2/kernel-value/single-input": 102 }], 89: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/dynamic-unsigned-array": 54 }], 90: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/dynamic-unsigned-input": 55 }], 91: [function(require, module2, exports2) {
      require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/float": 56 }], 92: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
...
`;
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/array": 40 }], 93: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/html-image": 57 }], 94: [function(require, module2, exports2) {
      require("../../../utils");
    ...
    }, { "../../../utils": 114, "./html-image": 93 }], 95: [function(require, module2, exports2) {
...
`;
    ...
    }, { "../../web-gl/kernel-value/integer": 60 }], 96: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/memory-optimized-number-texture": 61 }], 97: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/number-texture": 62 }], 98: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/single-array": 63 }], 99: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/single-array1d-i": 64 }], 100: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/single-array2d-i": 65 }], 101: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/single-array3d-i": 66 }], 102: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/single-input": 67 }], 103: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/unsigned-array": 68 }], 104: [function(require, module2, exports2) {
      const { utils } = require("../../../utils");
    ...
    }, { "../../../utils": 114, "../../web-gl/kernel-value/unsigned-input": 69 }], 105: [function(require, module2, exports2) {
      const { WebGLKernel } = require("../web-gl/kernel");
...
`;
    ...
    }, { "../../utils": 114, "../function-builder": 9, "../web-gl/kernel": 70, "./fragment-shader": 72, "./function-node": 73, "./kernel-value-maps": 74, "./vertex-shader": 106 }], 106: [function(require, module2, exports2) {
...
void main(void) {
  ...
  vTexCoord = aTexCoord;
    ...
    }, {}], 107: [function(require, module2, exports2) {
      ...
      module2.exports = lib;
    }, { "./index": 109 }], 108: [function(require, module2, exports2) {
      ...
      class GPU {
        ...
        createKernel(source, settings) {
          ...
          const kernel2 = new this.Kernel(source, mergedSettings);
          const kernelRun = kernelRunShortcut(kernel2);
          if (!this.canvas) {
            this.canvas = kernel2.canvas;
          }
          if (!this.context) {
            this.context = kernel2.context;
          }
    ...
    }, { "./backend/cpu/kernel": 8, "./backend/headless-gl/kernel": 34, "./backend/kernel": 36, "./backend/web-gl/kernel": 70, "./backend/web-gl2/kernel": 105, "./kernel-run-shortcut": 111, "./utils": 114, "gpu-mock.js": 4 }], 109: [function(require, module2, exports2) {
    ...
    }, { "./utils": 114 }], 111: [function(require, module2, exports2) {
      const { utils } = require("./utils");
      function kernelRunShortcut(kernel2) {
        let run = function() {
          kernel2.build.apply(kernel2, arguments);
          run = function() {
            let result = kernel2.run.apply(kernel2, arguments);
            if (kernel2.switchingKernels) {
              const reasons = kernel2.resetSwitchingKernels();
              const newKernel = kernel2.onRequestSwitchKernel(reasons, arguments, kernel2);
              shortcut.kernel = kernel2 = newKernel;
              result = newKernel.run.apply(newKernel, arguments);
            }
            if (kernel2.renderKernels) {
              return kernel2.renderKernels();
            } else if (kernel2.renderOutput) {
              return kernel2.renderOutput();
            } else {
              return result;
            }
          };
          return run.apply(kernel2, arguments);
        };
        ...
        shortcut.replaceKernel = function(replacementKernel) {
          kernel2 = replacementKernel;
          bindKernelToShortcut(kernel2, shortcut);
        };
        bindKernelToShortcut(kernel2, shortcut);
        return shortcut;
      }
      function bindKernelToShortcut(kernel2, shortcut) {
        if (shortcut.kernel) {
          shortcut.kernel = kernel2;
          return;
        }
        const properties = utils.allPropertiesOf(kernel2);
        for (let i = 0; i < properties.length; i++) {
          const property = properties[i];
          if (property[0] === "_" && property[1] === "_")
            continue;
          if (typeof kernel2[property] === "function") {
    ...
    }, { "./utils": 114 }], 112: [function(require, module2, exports2) {
...
highp float nrand(highp vec2 n) {
  ...
  return result;
      ...
      const onBeforeRun = (kernel2) => {
        kernel2.setUniform1f("randomSeed1", Math.random());
        kernel2.setUniform1f("randomSeed2", Math.random());
      };
      const plugin = {
        name: name2,
        onBeforeRun,
    ...
    }, {}], 113: [function(require, module2, exports2) {
      class Texture {
        constructor(settings) {
          const {
            texture,
    ...
    }, {}], 114: [function(require, module2, exports2) {
      const acorn = require("acorn");
      const { Input } = require("./input");
      const { Texture } = require("./texture");
...
${result2.join("")}}`;
        ...
        splitHTMLImageToRGB: (gpu2, image) => {
          const rKernel = gpu2.createKernel(function(a) {
          ...
          const gKernel = gpu2.createKernel(function(a) {
            const pixel = a[this.thread.y][this.thread.x];
            return pixel.g * 255;
          }, {
            output: [image.width, image.height],
          ...
          const bKernel = gpu2.createKernel(function(a) {
            const pixel = a[this.thread.y][this.thread.x];
            return pixel.b * 255;
          }, {
            output: [image.width, image.height],
          ...
          const aKernel = gpu2.createKernel(function(a) {
            const pixel = a[this.thread.y][this.thread.x];
            return pixel.a * 255;
          }, {
            output: [image.width, image.height],
        ...
        splitRGBAToCanvases: (gpu2, rgba, width, height) => {
          const visualKernelR = gpu2.createKernel(function(v) {
          ...
          visualKernelR(rgba);
          const visualKernelG = gpu2.createKernel(function(v) {
            const pixel = v[this.thread.y][this.thread.x];
          ...
          visualKernelG(rgba);
          const visualKernelB = gpu2.createKernel(function(v) {
            const pixel = v[this.thread.y][this.thread.x];
          ...
          visualKernelB(rgba);
          const visualKernelA = gpu2.createKernel(function(v) {
            const pixel = v[this.thread.y][this.thread.x];
...
const kernel = gpu.createKernel(function(GG, len, data) {
  let newX = 0;
  let newY = 0;
...
async function draw() {
  ...
  let start = new Date();
  dataArr = kernel(G, MAX_DOTS, dataArr);
...
init();
//# sourceMappingURL=index-15b1898c.js.map
